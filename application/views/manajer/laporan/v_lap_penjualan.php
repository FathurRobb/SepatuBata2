...
$no=0;
    foreach ($data->result_array() as $i) {
        ...
        $nofak=$i['jual_nofak'];
        $tgl=$i['jual_tanggal'];
        $barang_warna=$i['barang_kode'];
        $barang_nama=$i['barang_nama'];
        $barang_ukuran=$i['barang_ukuran'];
...
?>
    <tr>
        ...
        <td style="text-align:center;"><?php echo $barang_warna;?></td>
        <td style="text-align:left;"><?php echo $barang_nama;?></td>
        <td style="text-align:center;"><?php echo $barang_ukuran;?></td>
