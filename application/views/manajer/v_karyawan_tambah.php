    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
              <?php echo form_open('manajer/karyawan/tambah', array('enctype'=>'multipart/form-data')); ?>
              <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="kar_nik" placeholder="NIK Karyawan" maxlength="20" onkeypress="return hanyaAngka(event)" required/>
              </div>

              <div class="form-group">
                  <label>Nama Karyawan</label>
                  <input class="form-control" type="text" name="kar_nama" placeholder="Nama Karyawan" required/>
              </div>

              <div class="form-group">
                  <label>Tanggal Lahir</label>
                  <input class="form-control date" type="text" name="kar_tgl_lahir" required/>
              </div>

              <div class="form-group">
                  <label>Jenis Kelamin</label></b><br>
                  <input type="radio" name="kar_jenkel" value="Laki-Laki"> Laki-Laki
                  <input type="radio" name="kar_jenkel" value="Perempuan"> Perempuan
              </div>

              <div class="form-group">
                  <label><b>Alamat</label>
                  <textarea class="form-control" type="text" name="kar_alamat" placeholder="Alamat Karyawan" required></textarea> 
              </div>
              ...
              <div class="form-group">
                  ...
                  <input type="radio" name="kar_status_kawin" value="Kawin"> Kawin
                  <input type="radio" name="kar_status_kawin" value="Belum Kawin"> Belum Kawin
              </div>
              ...
              <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="kar_no_hp" placeholder="Nomor Handphone" maxlength="15" onkeypress="return hanyaAngka(event)" required/>
              </div>

              <div class="form-group">
                  <label>Nomor Rekening</label>
                  <input class="form-control" type="text" name="kar_norek" placeholder="Nomor Rekening" maxlength="20" onkeypress="return hanyaAngka(event)" required/>
              </div>              

              <div class="form-group">
                  <label>Tanggal Masuk</label>
                  <input class="form-control date" type="text" name="kar_tgl_masuk" required/>
              </div>
